...
exports.initLocals = function (req, res, next) {
	res.locals.navLinks = [
		...
		//{ label: 'Servises', key: 'servises', href: '#' },
		//{ label: 'Products', key: 'products', href: '/products' },
		{ label: 'Blog', key: 'blog', href: '/blog' },
		//{ label: 'Login', key: 'login', href: '/login' },
		{ label: 'Rus/Eng', key: '', href: '' },
	];
	res.locals.footerLinks = [
		{ label: 'Contacts', key: 'contacts', href: '/about#contacts' },
		{ label: 'Privacy', key: 'privacy', href: '/privacy' },
		{ label: 'Terms', key: 'terms', href: '/terms' },
